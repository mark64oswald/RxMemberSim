...
class DURAlert(BaseModel):
    ...
    drug1_ndc: str
    drug1_name: str
    drug1_gpi: Optional[str] = None

    drug2_ndc: Optional[str] = None
    drug2_name: Optional[str] = None
    drug2_gpi: Optional[str] = None
    ...
    result_of_service: Optional[str] = None

    # For early refill alerts
    days_early: Optional[int] = None
    previous_fill_date: Optional[date] = None
