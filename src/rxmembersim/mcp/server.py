...
from ..core.member import RxMemberGenerator
...
member_generator = RxMemberGenerator()
...
# Member cache for session
_member_cache: dict[str, Any] = {}
...
if MCP_AVAILABLE:
    ...
    async def generate_rx_member(
        ...
        _member_cache[member.member_id] = member
