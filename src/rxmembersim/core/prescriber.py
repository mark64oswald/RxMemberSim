...
class Prescriber(BaseModel):
    ...
    dea: Optional[str] = None  # DEA number for controlled substances
    ...
    specialty: Optional[PrescriberSpecialty] = None
    taxonomy_code: Optional[str] = None  # Provider taxonomy code
