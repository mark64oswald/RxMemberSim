...
class PriorAuthResponse(BaseModel):
    ...
    days_supply_approved: Optional[int] = None
    refills_approved: Optional[int] = None

    # Denial details
    denial_reason: Optional[PADenialReason] = None
...
class PriorAuthRecord(BaseModel):
    ...
    response: Optional[PriorAuthResponse] = None
...
class PriorAuthWorkflow:
    ...
    def get_record(self, pa_request_id: str) -> Optional[PriorAuthRecord]:
