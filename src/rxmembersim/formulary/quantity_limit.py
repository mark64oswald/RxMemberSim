...
class QuantityLimitResult(BaseModel):
    ...
    passed: bool
    limit_type: Optional[QuantityLimitType] = None
    ...
    quantity_remaining_in_period: Optional[Decimal] = None
...
class QuantityLimitManager:
    ...
    def find_limits_for_drug(
        self, ndc: str, gpi: Optional[str] = None
    ) -> list[QuantityLimit]:
    ...
    def check_quantity_limit(
        ...
        # Check each limit
        most_restrictive_result: Optional[QuantityLimitResult] = None
