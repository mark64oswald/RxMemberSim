...
class StepTherapyManager:
    ...
    def get_protocol(self, protocol_id: str) -> Optional[StepTherapyProtocol]:
        """Get protocol by ID."""
        return self.protocols.get(protocol_id)

    def find_protocol_for_drug(self, ndc: str) -> Optional[StepTherapyProtocol]:
