...
class PAInitiationResponse(BaseModel):
    ...
    pa_reference_number: Optional[str] = None
    ...
    # Question response
    question_set: Optional[ePAQuestionSet] = None
...
class PAResponse(BaseModel):
    ...
    # More info needed
    additional_questions: Optional[ePAQuestionSet] = None
